...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => { 
    ...
    try {
      ...
      //converting amenities object to array and keeping only enbabled amenities
    ...
    <form onSubmit={onSubmitHandler}>
      ...
      <div className="flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm">
        {Object.keys(inputs.amenities).map((amenity, index) => (
          ...
          <button className='bg-primary text-white px-8 py-2 rounded mt-8 cusor-pointer' disabled={loading}>{loading? 'Adding...':' Add Room'}</button>
    </form>
  );
}
